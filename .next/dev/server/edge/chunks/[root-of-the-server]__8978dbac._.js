...
function middleware(req) {
    ...
    if (pathname === '/login') {
        ...
        const target = from && from.startsWith('/') ? from : payload.role === 'ADMIN' ? '/admin/day' : '/cashier';
    ...
    if (pathname.startsWith('/user')) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/admin/day', req.url));
    }
    // 🔹 ADMIN може все
    if (role === 'ADMIN') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].next();
...
function decodeJWT(token) {
    try {
        ...
        return JSON.parse(__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].from(base64, 'base64').toString());
    } catch  {
        return null;
    }
}
