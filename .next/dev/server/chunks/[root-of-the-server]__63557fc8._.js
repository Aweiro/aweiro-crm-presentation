...
"[project]/src/app/api/admin/day/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const shift = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shift.findFirst({
            where: {
                isOpen: true
            }
        });
        ...
        const cardIncome = transactions.filter((t)=>t.paymentMethod === 'CARD').reduce((s, t)=>s + t.amount, 0);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__63557fc8._.js.map