...
"[project]/src/app/api/admin/shift/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (body.action === 'open') {
            const shift = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$shiftStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["openShift"])();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                shift
            });
        }
        if (body.action === 'cashStart') {
            const shift = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$shiftStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setCashStart"])(Number(body.amount));
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                shift
            });
        }
        if (body.action === 'close') {
            const cashEnd = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$shiftStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["closeShift"])();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                cashEnd
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3a60fea7._.js.map